import { useGetProgramAccountQuery } from '@/features/fractionalizationskytrade/data-access/use-get-program-account-query'

import { AppAlert } from '@/components/app-alert'
import { useSolana } from '@/components/solana/use-solana'

export function FractionalizationskytradeUiProgram() {
